...
public class Client {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			System.out.println("Scegliere operazione (C=Conta occorrenze carattere, T=Trasferimento file):\n");
			while ((operazione = stdIn.readLine()) != null) {
				...
				if (operazione.equals("C")) {
					...
					if (esito >= 0) {
						System.out.println("\nContate " + esito + " linee con almeno " + occorrenze + " occorrenze di " + c + "\n");
					} else
				...
				System.out.print("Scegliere operazione (C=Conta occorrenze parola, T=Trasferimento file):\n");
			}
