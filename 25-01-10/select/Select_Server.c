					...
					for (int i = 0; i < MAX_PREN; i++)
					{
						if (strcmp(prenotazioni[i].titolo, "L") != 0)
						{
							for (int j = 0; j < prenotazioni[i].copieTotali - prenotazioni[i].copieDisp; j++)
							{
								...
								else if (prenotazioni[i].copie[j][2] == aa && prenotazioni[i].copie[j][1] == mm && prenotazioni[i].copie[j][0] <= gg)
								{
									found++;
									break;
								}
						...
						if (strcmp(prenotazioni[i].titolo, "L") != 0)
						{
							for (int j = 0; j < prenotazioni[i].copieTotali - prenotazioni[i].copieDisp; j++)
							{
								if ((prenotazioni[i].copie[j][2] < aa) ||
									...
									(prenotazioni[i].copie[j][2] == aa && prenotazioni[i].copie[j][1] == mm && prenotazioni[i].copie[j][0] <= gg))
								{
